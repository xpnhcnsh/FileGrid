...
namespace FileGrid.Migrations
{
    ...
    [Migration("20250619123721_UpdateDrillHolePrecision")]
    partial class UpdateDrillHolePrecision
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DrillHoleOutsource", b =>
                {
                    b.Property<Guid>("DrillHoleId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("CompanyId")
                        .HasColumnType("int");

                    b.HasKey("DrillHoleId", "CompanyId");

                    b.HasIndex("CompanyId");

                    b.ToTable("DrillHoleOutsource", (string)null);
                });
            ...
            modelBuilder.Entity("FileGrid.Entities.CompletionCondition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FileGrid.Entities.DrillHole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("ParentDrillHoleId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FileGrid.Entities.Phase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FileGrid.Utils.PhaseParameter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DrillHoleOutsource", b =>
                {
                    ...
                    b.HasOne("FileGrid.Entities.DrillHole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FileGrid.Entities.CompletionCondition", b =>
                {
                    b.HasOne("FileGrid.Entities.Phase", null)
                        .WithMany("CompletionConditions")
            ...
            modelBuilder.Entity("FileGrid.Entities.DrillHole", b =>
                {
                    b.HasOne("FileGrid.Entities.DrillHole", "ParentDrillHole")
                        .WithMany()
                        .HasForeignKey("ParentDrillHoleId")
            ...
            modelBuilder.Entity("FileGrid.Entities.Phase", b =>
                {
                    b.HasOne("FileGrid.Entities.DrillHole", "DrillHole")
                        .WithMany("Phases")
                        .HasForeignKey("DrillHoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FileGrid.Entities.Phase", "ParentPhase")
                        .WithMany("SubPhases")
            ...
            modelBuilder.Entity("FileGrid.Entities.Phase", b =>
                {
                    b.Navigation("CompletionConditions");

                    b.Navigation("Parameters");

                    b.Navigation("SubPhases");
                });
